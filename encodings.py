...
# Paths
image_dir = r"C:\\Users\\username\\Desktop\\Deep learning project\\coco2017\\train"
output_dir = r"C:\\Users\\username\\Desktop\\Deep learning project\\deep\\encodings"
...
with torch.no_grad():
    for batch in dataloader:
        ...
        for i, encoding in enumerate(encodings):
            ...
            np.save(os.path.join(output_dir, f"{image_name}.npy"), encoding)
